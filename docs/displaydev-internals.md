...
coordinates — see [Displays — Browser / notebook](displaydev.md#browser--notebook-pyscript-jupyter).
...
[Board configs — Pixel configs](board-configs.md#pixel--addressable-led-configs)).
